...
public class TimeChecker {
    ...
    List<Long> iterationsRequired = new ArrayList<Long>();
    ...
    public void logToFile(String filename){
        try {
            ...
            System.out.println("average time taken for: " + algorithm + getAvgTime() + "\n");
            System.out.println("average iterations taken for: " + algorithm + getAvgIterations());
            fw.close();
        } catch (IOException e) {
            e.printStackTrace();
        }
